            ...
            if request.form['input_data'] != '':
                try:
                    ...
                    with output:
                        ...
                        pickled_data = base64.b64decode(request.form['input_data'])
                        # Use dill to load pickled data
                        pickle_obj = pickle.loads(pickled_data)
                        # Execute the pickled object
                        pickle_obj()
                ...
                try:
                    output = OutputGrabber()
                    with output:
                        pickled_data = base64.b64decode(file_data.decode())
                        # Use dill to load pickled data
                        pickle_obj = pickle.loads(pickled_data)
                        # Execute the pickled object
                        pickle_obj()
